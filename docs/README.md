...
Cross-cutting conceptual documentation for the AKD ecosystem. These pages are not specific to any one agent, framework, or product — they describe concepts that apply across all of them.
...
- [`getting-started.md`](./getting-started.md) — reader entry paths for different audiences (user / agent developer / operator / newcomer).

## Where to read next

- [`../README.md`](../README.md) — the top-level entry point to this repo.
- [`../frameworks/`](../frameworks/) — the code-facing framework docs.
- [`../agents/`](../agents/) — the published-agent knowledge artifacts.
